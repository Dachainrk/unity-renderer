...
namespace DCLServices.WearablesCatalogService
{
    ...
    public class LambdasWearablesCatalogService : IWearablesCatalogService, ILambdaServiceConsumer<WearableWithDefinitionResponse>
    {
            ...
            DataStore dataStore)
        {
            ...
            Debug.Log("  this.lambdasService  = " + this.lambdasService);
            Debug.Log("  WearablesCatalog  = " + WearablesCatalog);
            Debug.Log("  catalyst  = " + catalyst.lambdasUrl);
        }
            ...
            string name = null, (NftOrderByOperation type, bool directionAscendent)? orderBy = null)
        {
            ...
            Debug.Log("connet game");
            Debug.Log("wearblescatalogserbvive  explorerUrl=" + explorerUrl);
            Debug.Log("wearblescatalogserbvive  contentUrl=" + contentUrl);
