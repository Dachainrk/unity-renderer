    ...
    public class DebugConfigComponent : MonoBehaviour
    {
        ...
        private void OpenWebBrowser()
        {
            ...
            else if (baseUrlMode.Equals(BaseUrl.ORG))
            {
                ...
                {
                    Debug.LogError(
                        " only works with WebSocket SSL, please change the base URL to play.decentraland.zone");
                    QuitGame();
                    return;
                }
            }
            ...
            Application.OpenURL(
                ...
                Debug.Log(" application url =" +   $"{baseUrl}{debugString}{debugPanelString}position={startInCoords.x}%2C{startInCoords.y}&ws={DataStore.i.wsCommunication.url}");
#endif
        }
