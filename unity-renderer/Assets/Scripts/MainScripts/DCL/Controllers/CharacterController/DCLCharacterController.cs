...
public class DCLCharacterController : MonoBehaviour
{
    ...
    public void ModifyPlayerMoveSpeed(float newSpeed)
    {
        movementSpeed = newSpeed;
    }

    public void ModifyPlayerJumpForce(float newJumpforce)
    {
        jumpForce = newJumpforce;
    }

    public void GetPlayerMoveSpeed() { }
    ...
    public void SetPosition(string positionVector) { Debug.Log("测试6"); Teleport(positionVector); }
