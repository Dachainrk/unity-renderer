...
public class Catalyst : ICatalyst
{
    ...
    // private string realmDomain = "https://peer.dachainrk.com";
    private string realmDomain = "";
    // private string realmContentServerUrl = "https://peer.dachainrk.com/content/";
    ...
    public Catalyst()
    {
        if (playerRealm.Get() != null)
        {
            ...
            Debug.Log("playerRealm.Get().contentServerUrl = " + playerRealm.Get().contentServerUrl);
        }
        else if (aboutConfiguration.Get() != null)
        {
            ...
            if (!string.IsNullOrEmpty(aboutContent.Get().PublicUrl))
              ...
              Debug.Log("aboutContent.Get().PublicUrl = " + aboutContent.Get().PublicUrl);
        }


        

        Debug.Log("realmContentServerUrl = " + realmContentServerUrl);
        Debug.Log("playerRealm = " + playerRealm);
        Debug.Log("aboutLambdas = " + aboutLambdas);
        Debug.Log("aboutContent = " + aboutContent);
        Debug.Log("aboutConfiguration = " + aboutConfiguration);
    ...
    private void PlayerRealmOnChange(CurrentRealmModel current, CurrentRealmModel previous)
    {
        ...
        Debug.Log("lambdasUrl = " + lambdasUrl);
        Debug.Log("realmContentServerUrl = " + realmContentServerUrl);
