    ...
    public class DCLAvatarTexture : DCLTexture
    {
        ...
        public override IEnumerator ApplyChanges(BaseModel newModel)
        {
            ...
            if (texture == null && !string.IsNullOrEmpty(model.userId))
            {
                ...
                Debug.Log("Environment.i.platform.serviceProviders.catalyst.lambdasUrl =" + Environment.i.platform.serviceProviders.catalyst.lambdasUrl);
                Debug.Log("Environment.i.platform.serviceProviders.catalyst =" + Environment.i.platform.serviceProviders.catalyst);
                Debug.Log("sourceUrl = " + sourceUrl);
